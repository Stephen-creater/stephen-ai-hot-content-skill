...
人工反馈已确认 Boris Cherny 与 Tara Seshan 的深度访谈／有判断的中文解读值得选；不能因局部涉及编程、组织或产品而整类排除。反之，“从使用 AI 到委托 AI”式泛论，即使很长、有一次失败故事、提到任务约定和验收，若主体仍是常识性建议，也不算干货。终审必须指出原文自身提供了什么具体新判断、操作细节或有条件的取舍，不能靠推荐理由给原文补价值。
